var CZombies = function(b, a) {
    ...
    oGoblin = InheritO(OrnNoneZombies, {
        EName: "oGoblin",
        CName: "Zombie",
        StandGif: 9,
        PicArr: function() {
            var a = "images/Zombies/Goblin/";
        ...
        Produce: 'Toughness: <font color="#FF0000">Low</font></p> This zombie loves brains, and is insatiable and greedy. Brains, brains, brains, day and night. Old, smelly brains? Rotting brains? It doesnt matter. The zombie needs them.'
    }),
	...
	oMouse = InheritO(OrnNoneZombies, {
        EName: "oMouse",
        CName: "Mouse",
        StandGif: 9,
        PicArr: function() {
            var a = "images/Zombies/Mouse/";
            return ["images/Card/Zombies/Zombie.png", a + "0.gif", a + "Zombie.gif", a + "ZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, "images/Zombies/BoomDie.gif" + $Random, a + "1.gif"]
        }(),
        Produce: 'Toughness: <font color="#FF0000">Low</font></p> This zombie loves brains, and is insatiable and greedy. Brains, brains, brains, day and night. Old, smelly brains? Rotting brains? It doesnt matter. The zombie needs them.'
    }),
    oBVZombie = InheritO(OrnNoneZombies, {
        EName: "oBVZombie",
        CName: "BV普通僵尸",
        StandGif: 9,
        PicArr: function() {
            var a = "images/Zombies/BVZombie/";
            return ["images/Card/Zombies/Zombie.png", a + "0.gif", a + "Zombie.gif", a + "ZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, "images/Zombies/BoomDie.gif" + $Random, a + "1.gif"]
        }(),
    ...
    oFlagZombie = InheritO(oZombie, {
        ...
        Produce: 'The Flag Zombie marks the oncoming "flow" of zombies. <p>Toughness: <font color="#FF0000">Low</font></p> Flag Zombie loves brains, no doubt about it. But secretly hes also obsessed with flags. Maybe its because there are brains on flags, too. Its hard to say.'
    }),
    ...
    oConeheadZombie = InheritO(OrnIZombies, {
        ...
        Produce: 'His Roadblock Helmet makes him twice as tough as a normal zombie. <p>Toughness: <font color="#FF0000">Medium</font></p>Like all other zombies, ConeHead Zombie moves blindly forward. But something stops him in his tracks, and he picks up a traffic block and attaches it to his head. Yes, he likes to party.'
    }),
    ...
    oChickenJockey = InheritO(OrnNoneZombies, {
        ...
        StandGif: 9,
        PicArr: function() {
            var a = "images/Zombies/ChickenJockey/";
            return ["images/Card/Zombies/Zombie.png", a + "0.gif", a + "ConeheadZombie.gif", a + "ConeheadZombieAttack.gif", a + "ZombieLostHead.gif", a + "ZombieLostHeadAttack.gif", a + "ZombieHead.gif" + $Random, a + "ZombieDie.gif" + $Random, "images/Zombies/BoomDie.gif" + $Random, a + "1.gif"]
        }(),
        Produce: '韧性：<font color="#FF0000">低</font></p>这种僵尸喜爱脑髓，贪婪而不知足。脑髓，脑髓，脑髓，夜以继日地追求着。老而臭的脑髓？腐烂的脑髓？都没关系。僵尸需要它们。'
    }),
    oBucketheadZombie = InheritO(oConeheadZombie, {
        ...
        Produce: 'His bucket helmet can withstand a great deal of damage. <p>Toughness: <font color="#FF0000">High</font><br>Weakness: <font color="#FF0000">Potato Mine</font></p> Bucket Head Zombie often wears a bucket, which makes him unique in the cold world. But in fact, he just forgot that the bucket is still on his head.'
    }, {
        PicArr: {
    ...
    oPoleVaultingZombie = InheritO(OrnNoneZombies, {
        ...
        Produce: 'Pole Vaulting Zombies use poles to leap high over obstacles. <p>Toughness: <font color="#FF0000">Medium</font><Br>Speed: <font color="#FF0000">Fast, then slow (after jumping)</font><BR>Features: <font color="#FF0000">Leaps over the first plant he encounters</font></p>Some zombies crave to go further and get more, which drives them from ordinary to extraordinary. Thats the Pole Vaulting Zombie.',
        getShadow: function(a) {
    ...
    oNewspaperZombie = InheritO(OrnIIZombies, {
        ...
        Produce: 'His newspapers offer limited defense. <p>Toughness: <font color="#FF0000">Low</font><br>Newspaper Toughness: <font color="#FF0000">Low</font><br>Speed: Normal, then fast (after losing the newspaper)</p>A newspaper-reading zombie who is obsessed with completing his Sudoku puzzle. No wonder hes so abnormal.',
        getShadow: function(a) {
