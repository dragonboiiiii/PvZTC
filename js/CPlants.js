var CPlants = NewO({
    ...
    oPeashooter = InheritO(CPlants, {
        ...
        Tooltip: "Peashooter shoots peas, what did ya expect?",
    ...
    oShooter1 = InheritO(CPlants, {
        ...
        BKind: 0,
        AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
        PicArr: ["images/Card/Plants/shooter1.png", "images/Plants/Peashooter/0.gif", "images/Plants/Shooter1/Peashooter.gif", "images/Plants/PB00.gif", "images/Plants/PeaBulletHit.gif"],
        Tooltip: "shooter shoots peas, what did ya expect?",
        Produce: 'Peashooters, your first line of defense. They attack zombies by shooting peas. <p>Damage: <font color="#FF0000">Medium</font></p> How can a plant grow so fast and shoot so many peas? Peashooter: "Hard work, dedication, and a balanced combination of sunshine, high fiber and carbon dioxide make this healthy breakfast possible.”',
        PrivateBirth: function(a) {
            a.BulletEle = NewImg(0, a.PicArr[3], "left:" + (a.AttackedLX - 40) + "px;top:" + (a.pixelTop + 3) + "px;visibility:hidden;z-index:" + (a.zIndex + 2))
        },
    ...
    oBeeshooter = InheritO(CPlants, {
        ...
        BKind: 0,
        AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
        PicArr: ["images/Card/Plants/Beeshooter.png", "images/Plants/Beeshooter/0.gif", "images/Plants/Beeshooter/Peashooter.gif", "images/Plants/Beeshooter/bee.png", "images/Plants/Beeshooter/bee.png"],
        Tooltip: "Beeshooters shoots bees, what did ya expect?",
        Produce: 'Peashooters, your first line of defense. They attack zombies by shooting peas. <p>Damage: <font color="#FF0000">Medium</font></p> How can a plant grow so fast and shoot so many peas? Peashooter: "Hard work, dedication, and a balanced combination of sunshine, high fiber and carbon dioxide make this healthy breakfast possible.”',
        PrivateBirth: function(a) {
            a.BulletEle = NewImg(0, a.PicArr[3], "left:" + (a.AttackedLX - 40) + "px;top:" + (a.pixelTop + 3) + "px;visibility:hidden;z-index:" + (a.zIndex + 2))
        },
    ...
    oBird = InheritO(CPlants, {
        ...
        BKind: 0,
        AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
        PicArr: ["images/Card/Plants/Bird.png", "images/Plants/Bird/0.gif", "images/Plants/Bird/bird.gif", "images/Plants/BirdBullet.gif", "images/Plants/BirdBullet.gif"],
        Tooltip: "Bird shoots poop",
    ...
    oSnowPea = InheritO(oPeashooter, {
        ...
        Tooltip: "Peashooter but cold",
        Produce: 'Snow Pea  fires cold Peas at zombies, which have a </font><br>slowing effect. <p>Damage: <font color="#FF0000">Medium, with a slowing effect</font></p>People often tell Snow Pea how "cold" he is, or </font><br>tell him to "be cool". They tell him to "keep cool". Snow Pea just rolls his eyes. He hears it all.',
        NormalAttack: function() {
            var a = this,
                b = "PB" + Math.random();
            EditEle(a.BulletEle.cloneNode(false), {
    ...
    oRepeater = InheritO(oPeashooter, {
        ...
        AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
        Tooltip: "Double peas",
        Produce: 'Repeater can fire two peas at once<p>Damage:<font color="#FF0000">Medium (per pea)</font><br>Fire Rate: <font color="#FF0000">Double</font></p>Repeater is tough, he grew up on the streets. He doesnt care</font><br>what anyone thinks, whether it is plants or zombies. He fires.</font><br>peas to make people stay away from him. But deep down,</font><br>Repeater has always secretly longed for love.',
    ...
    oKingCactus = InheritO(oPeashooter, {
        EName: "oKingCactus",
        CName: "King Cactus",
        width: 88,
        height: 84,
        beAttackedPointR: 68,
        SunNum: 275,
        PicArr: ["images/Card/Plants/KingCactus.png", "images/Plants/KingCactus/0.gif", "images/Plants/KingCactus/GatlingPea.gif", "images/Plants/KingCactus/Projectile32.png", "images/Plants/KingCactus/Projectile32.png"],
        AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
        Tooltip: "gatling cactus fr",
        Produce: '机枪射手可以一次发射四颗豌豆<p>伤害：<font color="#FF0000">中等(每颗)</font><br>发射速度：<font color="#FF0000">四倍<br>可以种在双发射手上</font></p>当加特林宣布他要参军的时候，他的父母很为</font><br>他担心，他们异口同声地对他说：“亲爱的，</font><br>这太危险了。”加特林拒绝让步，“生活就危</font><br>险，”他这样回答着，此时他的眼睛里，正</font><br>闪烁着钢铁般的信念。',
        PrivateBirth: function(c) {
            var b = c.AttackedLX,
                a = b - 40;
    ...
    oSunFlower = InheritO(CPlants, {
        ...
        Tooltip: "Sunflower makes sun that equals 50 sun.",
	...
	oFire = InheritO(CPlants, {
        ...
        beAttackedPointR: 53,
        SunNum: 50,
        PicArr: ["images/Card/Plants/Fire.png", "images/Plants/Fire/0.gif", "images/Plants/Fire/SunFlower1.gif", "images/Plants/Fire/SunFlower.gif"],
        Tooltip: "Fire makes sun that equals 50 sun.",
        Produce: 'Sunflower produces sunlight that equals 50 each per sun.</font><br>Plant as many as you can!<p>Sunlight output：<font color="#FF0000">Medium</font></p>The sunflowers couldnt help but dance to the beat. What is that beat?</font><br>What? Hey, its the jazz beat that the earth itself uses to refresh itself.</font><br>This is a beat of a frequency that only sunflowers can hear.',
        BirthStyle: function(c, e, b, a) {
            var d = b.childNodes[1];
            d.src = "images/Plants/Fire/SunFlower.gif";
            d.style.clip = "rect(0,auto,74px,0)";
            d.style.height = "148px";
            EditEle(b, {
                id: e
    ...
    oSun1 = InheritO(CPlants, {
        ...
        beAttackedPointR: 53,
        SunNum: 50,
        PicArr: ["images/Card/Plants/sun1.png", "images/Plants/Sun1/0.gif", "images/Plants/Sun1/SunFlower1.gif", "images/Plants/Sun1/SunFlower.gif"],
        Tooltip: "flower makes sun that equals 50 sun.",
        Produce: 'Sunflower produces sunlight that equals 50 each per sun.</font><br>Plant as many as you can!<p>Sunlight output：<font color="#FF0000">Medium</font></p>The sunflowers couldnt help but dance to the beat. What is that beat?</font><br>What? Hey, its the jazz beat that the earth itself uses to refresh itself.</font><br>This is a beat of a frequency that only sunflowers can hear.',
        BirthStyle: function(c, e, b, a) {
            var d = b.childNodes[1];
            d.src = "images/Plants/Sun1/SunFlower.gif";
            d.style.clip = "rect(0,auto,74px,0)";
            d.style.height = "148px";
            EditEle(b, {
                id: e
    ...
    oAmpliflower = InheritO(oSunFlower, {
        EName: "oAmpliflower",
        CName: "Ampliflower",
        width: 83,
        height: 84,
        beAttackedPointR: 63,
        SunNum: 150,
        PicArr: ["images/Card/Plants/Ampliflower.png", "images/Plants/Ampliflower/0.gif", "images/Plants/Ampliflower/Sunflower1.gif", "images/Plants/Ampliflower/Sunflower.gif"],
        Tooltip: "too lazy to code it right<br>",
        Produce: '双胞向日葵的阳光产量是普通向日葵的两倍。<p>阳光产量：<font color="#FF0000">双倍<br>可以种在普通向日葵上</font></p>这是一个疯狂的夜晚，禁忌的科学技术，让双</font><br>胞向日葵来到了这个世界。电闪雷鸣狂风怒吼</font><br>，都在表示着这个世界对他的拒绝。但是一切</font><br>无济于事，双子向日葵他却仍然活着！',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
        ...
        BirthStyle: function(c, e, b, a) {
            var d = b.childNodes[1];
            d.src = "images/Plants/Ampliflower/Sunflower.gif";
            d.style.clip = "rect(0,auto,84px,0)";
            d.style.height = "168px";
            EditEle(b, {
                id: e
    ...
    oPotatoMine = InheritO(CPlants, {
        ...
        Tooltip: "Potato go boom<br>But wait",
        Produce: 'Potato Mines are powerful, but they take a while to arm themselves. You plant them in the path of zombies, and they explode when they are touched. <p>Damage: <font color="FF0000">Huge</font><br>Range: <font color="#FF0000">All zombies in a small area</font><br>Usage: <font color="#FF0000">Single, requires some preparation time. </font></p>Some people say that Potato Mines are lazy because they always leave everything</font><br>for the last minute. Potato Mines has no time for them, he is busy thinking about his investment strategy。',
        Status: 0,
    ...
    oWallNut = InheritO(CPlants, {
        ...
        Tooltip: "The nut wall has a hard shell that is strong enough to protect other plants.",
        Produce: 'The nut wall is strong enough for you to use to protect other plants.</font><br>Shell. <p>Toughness: <font color="FF0000">High</font></p>Nut Wall: "People want to know what it feels like to be constantly gnawed by zombies. They dont know that my limited senses can only give me a tingling sensation, like a relaxing back massage."”',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
                e = oS.ArP;
    ...
    oTallNut = InheritO(oWallNut, {
	 ...
	 oPurpleGourd = InheritO(oWallNut, {
        EName: "oPurpleGourd",
        CName: "Oh-my-gourd",
        width: 83,
        height: 119,
        beAttackedPointR: 689,
        SunNum: 125,
        HP: 8e3,
        coolTime: 50.5,
        PicArr: ["images/Card/Plants/PurpleGourd.png", "images/Plants/PurpleGourd/0.gif", "images/Plants/PurpleGourd/TallNut.gif", "images/Plants/PurpleGourd/TallnutCracked1.gif", "images/Plants/PurpleGourd/TallnutCracked2.gif"],
        Tooltip: "Defends your lawn with extreme durability",
        Produce: '高坚果是重型壁垒植物，而且不会被跳过。<p>韧性：<font color="#FF0000">非常高</font><br>特殊：<font color="#FF0000">不会被跨过或越过</font></p>人们想知道，坚果墙和高坚果是否在竞争。高</font><br>坚果以男中音的声调大声笑了。“我们之间怎么</font><br>会存在竞争关系？我们是哥们儿。你知道坚果墙</font><br>为我做了什么吗……”高坚果的声音越来越小，</font><br>他狡黠地笑着。”',
        CanGrow: function(c, b, f) {
            var a = b + "_" + f,
                d = c[1],
        ...
        getHurt: function(e, b, a) {
            var c = this,
                d = $(c.id).childNodes[1];
            !(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 2667 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src = "images/Plants/PurpleGourd/TallnutCracked2.gif") : c.HP < 5333 && c.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/Plants/PurpleGourd/TallnutCracked1.gif"): c.Die(1)
        }
    }),
    ...
    oCherryBomb = InheritO(CPlants, {
        ...
        AudioArr: ["cherrybomb"],
        Tooltip: "Cherry go boom",
        Produce: 'Cherry Bombs, which can blow up all zombies in a certain area. They will explode as soon as they are planted. So plant them near zombies.</font><br>Around us.<p>harm:<font color="#FF0000">huge</font><br>scope:<font color="#FF0000">All zombies in a medium area</font><br>Directions:<font color="#FF0000">Used alone, it explodes immediately. "I am going to explode." Cherry No. 1 said. "No, we are going to explode!" said its brother Cherry No. 2. After a fierce discussion, they finally agreed on the term "explosion."”',
        InitTrigger: function() {},
        getHurt: function() {},
        PrivateBirth: function(a) {
	...
	oBuduhboom = InheritO(CPlants, {
        ...
        SunNum: 150,
        coolTime: 20,
        PicArr: ["images/Card/Plants/Buduhboom.png", "images/Plants/Buduhboom/0.gif", "images/Plants/Buduhboom/CherryBomb.gif", "images/Plants/Buduhboom/Boom.gif" + $Random],
        AudioArr: ["cherrybomb"],
        Tooltip: "butter go boom",
        Produce: 'Cherry Bombs, which can blow up all zombies in a certain area. They will explode as soon as they are planted. So plant them near zombies.</font><br>Around us.<p>harm:<font color="#FF0000">huge</font><br>scope:<font color="#FF0000">All zombies in a medium area</font><br>Directions:<font color="#FF0000">Used alone, it explodes immediately. "I am going to explode." Cherry No. 1 said. "No, we are going to explode!" said its brother Cherry No. 2. After a fierce discussion, they finally agreed on the term "explosion."”',
        InitTrigger: function() {},
        getHurt: function() {},
        PrivateBirth: function(a) {
    ...
    oDevourBloom = InheritO(CPlants, {
        ...
        SunNum: 150,
        AudioArr: ["bigchomp"],
        PicArr: ["images/Card/Plants/DevourBloom.png", "images/Plants/DevourBloom/0.gif", "images/Plants/DevourBloom/Chomper.gif", "images/Plants/DevourBloom/ChomperAttack.gif", "images/Plants/DevourBloom/ChomperDigest.gif"],
        Tooltip: "chomp chomp chomp",
        Produce: 'PAC MANs can swallow zombies whole, but are very weak when digesting zombies. <p>Damage: Huge</font><br>Range: Very Close</font><br>Features: Long Digestion Time</font></p> PAC MANs could almost go to Little Shop of Horrors to perform his special tricks, but his agent squeezed him out of money, so he didnt go. Despite this, PAC MANs didnt complain, and just said it was part of the deal.',
        GetDX: function() {
            return -40
        },
        getShadow: function(a) {
        ...
        NormalAttack: function(a, b) {
            $(a).childNodes[1].src = "images/Plants/DevourBloom/ChomperAttack.gif" + $Random + Math.random();
            oSym.addTask(70, function(c, d) {
                ...
                $P[c] && oSym.addTask(18, function(e, f) {
                    ...
                    g && ((h = $Z[f]) && h.beAttacked && h.PZ ? $(e).childNodes[1].src = h.getRaven(e) ? (oSym.addTask(4200, function(i) {
                        var j = $P[i];
                        j && (j.canTrigger = 1, $(i).childNodes[1].src = "images/Plants/DevourBloom/Chomper.gif")
                    }, [e]), "images/Plants/DevourBloom/ChomperDigest.gif") : (g.canTrigger = 1, "images/Plants/DevourBloom/Chomper.gif") : oSym.addTask(18, function(i) {
                        var j = $P[i];
                        j && (j.canTrigger = 1, $(i).childNodes[1].src = "images/Plants/DevourBloom/Chomper.gif")
                    }, [e]))
                }, [c, d])
    ...
    oPuffShroom = InheritO(oFumeShroom, {
        ...
        AudioArr: ["puff"],
        Tooltip: "Fires short-range bubble spores at enemies",
        Produce: 'Spongepuff costs no sun, but has a very short range.<p>Damage: <font color="#FF0000">Medium</font><br>Range: <font color="#FF0000">Short<br>Sleeps during the day</font></p>Spongepuff: "I used to be just an ordinary kitchen sponge,</font><br>until a mushroom gave me consciousness.</font><br>Now, I fight zombies with bubbles—and clean up the battlefield too.</font><br>But honestly, I’d rather be taking a bath.”',
...
oVacuumPlant = InheritO(oChomper, {
    EName: "oVacuumPlant",
    CName: "吸尘植物",
    coolTime: 0,
    SunNum: 0,
    Tooltip: "吸尘植物会吸整行的僵尸，拖到嘴边后吃掉。",
    PicArr: [
    ...
    Produce: '吸尘植物可以吸整行的僵尸到自己嘴边。',
    PrivateBirth: function (self) {
        oSym.addTask(30, function pullLoop() {
            var plant = $P[self.id];
            if (!plant) return;
            ...
            for (let i = 0; i < $Z.length; i++) {
                let z = $Z[i];
                if (!z || z.R !== plant.R || !z.beAttacked || !z.PZ || !z.Ele || !z.Ele.style.left) continue;

                let zombieLeft = parseInt(z.Ele.style.left) || 0;
                let newLeft = zombieLeft - 2;

                if (newLeft <= plant.pixelLeft + 5) {
                    PlayAudio("bigchomp");
                    z.DisappearDie();
                    $(plant.id).childNodes[1].src = "images/Plants/BigChomper/ChomperDigest.gif";
                    oSym.addTask(2100, function (id) {
                        let p = $P[id];
                        p && (p.canTrigger = 1, $(id).childNodes[1].src = "images/Plants/BigChomper/Chomper.gif");
                    }, [plant.id]);
                } else {
                    z.Ele.style.left = newLeft + "px";
                    z.AttackedLX = newLeft;
                    z.AttackedRX = newLeft + 50;
                    pulled = true;
                }
            }

            if (pulled) {
                $(plant.id).childNodes[1].src = "images/Plants/BigChomper/ChomperAttack.gif";
            }

            oSym.addTask(30, arguments.callee);
        });
    }
});
oCalmChuck = InheritO(CPlants, {
    EName: "oCalmChuck",
    CName: "Calm Chuck",
    width: 97,
    height: 67,
    ...
    coolTime: 30,
    zIndex: 1,
    PicArr: ["images/Card/Plants/CalmChuck.png", "images/Plants/CalmChuck/0.gif", "images/Plants/CalmChuck/PumpkinHead.gif", "images/Plants/CalmChuck/PumpkinHead1.gif", "images/Plants/PumpkinHead/PumpkinHead2.gif", "images/Plants/CalmChuck/pumpkin_damage1.gif", "images/Plants/CalmChuck/pumpkin_damage2.gif", "images/Plants/CalmChuck/Pumpkin_back.gif"],
    Tooltip: "A Clone of pumpkin.",
    Produce: '南瓜头，可以用他的外壳保护其他植物。<p>韧性：<font color="#FF0000">高</font><br>特点：<font color="#FF0000">可以种在其他植物上</font></p>南瓜头最近都没收到，关于他表哥刃菲尔德的</font><br>消息。很明显，刃菲尔德是个大明星，是一种……</font><br>叫什么运动来着……的体育明星？佩格跳跳球大</font><br>师？南瓜头反正搞不懂是什么运动，他只想做好</font><br>他自己的工作。',
    CanGrow: function(c, b, d) {
        var a = b + "_" + d;
        return c[2] ? 1 : oGd.$LF[b] == 1 ? !(d < 1 || d > 9 || oGd.$Crater[a] || oGd.$Tombstones[a]) : c[0]
    ...
    getHurt: function(e, c, b) {
        ...
        switch (true) {
            ...
            case (d.HP -= b) < 1:
                ...
                break;
            case d.HP < 1334:
                d.HurtStatus < 2 && (d.HurtStatus = 2, a.childNodes[1].src = "images/Plants/CalmChuck/pumpkin_damage2.gif");
                break;
            case d.HP < 2667:
                d.HurtStatus < 1 && (d.HurtStatus = 1, a.childNodes[1].src = "images/Plants/CalmChuck/pumpkin_damage1.gif", $(f + "_2").src = "images/Plants/PumpkinHead/Pumpkin_back.gif")
        }
    },
    InitTrigger: function() {},
    BirthStyle: function(c, d, b, a) {
        b.childNodes[1].src = "images/Plants/CalmChuck/PumpkinHead1.gif";
        EditEle(b, {
            id: d
        }, a, EDPZ);
        NewImg(d + "_2", "images/Plants/CalmChuck/PumpkinHead2.gif", "left:" + c.pixelLeft + "px;top:" + c.pixelTop + "px;z-index:" + (c.zIndex - 2), EDPZ)
    },
    PrivateDie: function(a) {
        ClearChild($(a.id + "_2"))
    }
})
oLemonade = InheritO(CPlants, {
    EName: "oLemonade",
    CName: "Lemon nade",
    width: 112,
    height: 81,
    ...
    SunNum: 150,
    coolTime: 20,
    PicArr: ["images/Card/Plants/Lemonade.png", "images/Plants/Lemonade/0.gif", "images/Plants/Lemonade/CherryBomb.gif", "images/Plants/Lemonade/Boom.gif" + $Random],
    AudioArr: ["cherrybomb"],
    Tooltip: "Lemon go boom",
    Produce: 'Cherry Bombs, which can blow up all zombies in a certain area. They will explode as soon as they are planted. So plant them near zombies.</font><br>Around us.<p>harm:<font color="#FF0000">huge</font><br>scope:<font color="#FF0000">All zombies in a medium area</font><br>Directions:<font color="#FF0000">Used alone, it explodes immediately. "I am going to explode." Cherry No. 1 said. "No, we are going to explode!" said its brother Cherry No. 2. After a fierce discussion, they finally agreed on the term "explosion."”',
    InitTrigger: function() {},
    getHurt: function() {},
    PrivateBirth: function(a) {
...
var CPlants = NewO({
	...
	oDumpling = InheritO(CPlants, {
		...
		PicArr: [
			"images/Card/Plants/Dumpling.png",
			"images/Plants/Dumpling/0.gif",
			"images/Plants/Dumpling/Peashooter.gif",
			"images/Plants/DB00.gif",
			"images/Plants/PeaBulletHit.gif",
		],
		Tooltip: "Shoots dumplings at the enemy",
		Produce:
			'<font color="#28325A">Pea shooters are your first line of defense. They shoot peas at attacking zombies.</font><p>Damage: <font color="#CC241D">normal</font></p>How can a single plant grow and shoot so many peas so quickly? Peashooter says, "Hard work, commitment, and a healthy, well-balanced breakfast of sunlight and high-fiber carbon dioxide make it all possible." ',
		PrivateBirth: function (a) {
			a.BulletEle = NewImg(
	...
	oCornfetti = InheritO(CPlants, {
		...
		PicArr: [
			"images/Card/Plants/Cornfetti.png",
			"images/Plants/Cornfetti/0.gif",
			"images/Plants/Cornfetti/Peashooter.gif",
			"images/Plants/CORNFETTIBULLET.gif",
			"images/Plants/PeaBulletHit.gif",
		],
		Tooltip: "Shoots explosive corn at the enemy",
		Produce:
			'<font color="#28325A">Pea shooters are your first line of defense. They shoot peas at attacking zombies.</font><p>Damage: <font color="#CC241D">normal</font></p>How can a single plant grow and shoot so many peas so quickly? Peashooter says, "Hard work, commitment, and a healthy, well-balanced breakfast of sunlight and high-fiber carbon dioxide make it all possible." ',
		PrivateBirth: function (a) {
			a.BulletEle = NewImg(
	...
	oSourShot = InheritO(CPlants, {
		...
		PicArr: [
			"images/Card/Plants/Sourshot.png",
			"images/Plants/Sourshot/0.gif",
			"images/Plants/Sourshot/Peashooter.gif",
			"images/Plants/DB00.gif",
			"images/Plants/PeaBulletHit.gif",
		],
		Tooltip: "Shoots explosive shots at the enemy",
		Produce:
			'<font color="#28325A">Pea shooters are your first line of defense. They shoot peas at attacking zombies.</font><p>Damage: <font color="#CC241D">normal</font></p>How can a single plant grow and shoot so many peas so quickly? Peashooter says, "Hard work, commitment, and a healthy, well-balanced breakfast of sunlight and high-fiber carbon dioxide make it all possible." ',
		PrivateBirth: function (a) {
			a.BulletEle = NewImg(
...
*/ // same thing here
	...
	oPotato = InheritO(CPlants, {
		...
		PicArr: [
			"images/Card/Plants/Potato.png",
			"images/Plants/Potato/0.gif",
			"images/Plants/Potato/PotatoMine.gif",
			"images/Plants/Potato/PotatoMineNotReady.gif",
			"images/Plants/Potato/PotatoMine_mashed.gif",
			"images/Plants/Potato/ExplosionSpudow.gif",
		],
		Tooltip: "Explodes on contact, but takes time to arm itself",
		Produce:
			'<font color="#28325A">Potato Mines pack a powerful punch, but they need a while to arm themselves. You should plant them ahead of zombies. They will explode on contact.</font><p>Damage: <font color="CC241D">massive</font><br>Range: <font color="#CC241D">all zombies in a small area</font><br>Usage: <font color="#CC241D">single use, delayed activation</font></p>Some folks say Potato Mine is lazy, that he leaves everything to the last minute. Potato Mine says nothing. He\'s too busy thinking about his investment strategy.',
...
*/
	...
	oHypnoShroom = InheritO(oFumeShroom, {
		...
		Produce:
			'<font color="#28325A">When eaten, Hypno-puffs will make a zombie turn around and fight for you.</font><p>Usage: <font color="#CC241D">single use, on contact</font><br>Special: <font color="#CC241D">makes a zombie fight for you</font><br><font color="#8832aa">Sleeps during the day</font></p>"Zombies are our friends," asserts Hypno-puff. "They\'re badly misunderstood creatures who play a valuable role in our ecology. We can and should do more to bring them round to our way of thinking."',
		InitTrigger: function () {},
		getHurt: function (d, b, a) {
			var c = this;
			switch (b) {
